...
"px Arial",d),d.x=h,d.y=m,f.addChild(d),f.update();break;case "tategaki":for(e=0,g=b.length;e<g;++e)k=b[e].text||"",h=b[e].x||0,m=b[e].y||0,q=b[e].size||"30",d=b[e].color||"#000000",d=new createjs.Text(k,q+"px Arial",d),d.x=h,d.y=m,d.blockProgression="rl",d.textAlign="center",f.addChild(d),f.update()}x(l)}}}};
